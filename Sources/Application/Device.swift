...
struct Device {
    ...
    init(pointer: OpaquePointer) throws {
        ...
        print("config:", config[0].description)
        print("descriptor:", descriptor, terminator: "\n\n")
    }
}
...
extension libusb_device_descriptor: CustomStringConvertible {
    public var description: String {
        var values: [String] = []
        values.append(["bLength", String(bLength, radix: 16)].joined(separator: ": "))
        values.append(["bDescriptorType", String(bDescriptorType, radix: 16)].joined(separator: ": "))
        values.append(["bcdUSB", String(bcdUSB, radix: 16)].joined(separator: ": "))
        values.append(["bDeviceClass", String(bDeviceClass, radix: 16)].joined(separator: ": "))
        values.append(["bDeviceSubClass", String(bDeviceSubClass, radix: 16)].joined(separator: ": "))
        values.append(["bDeviceProtocol", String(bDeviceProtocol, radix: 16)].joined(separator: ": "))
        values.append(["bMaxPacketSize0", String(bMaxPacketSize0, radix: 16)].joined(separator: ": "))
        values.append(["idVendor", String(idVendor, radix: 16)].joined(separator: ": "))
        values.append(["idProduct", String(idProduct, radix: 16)].joined(separator: ": "))
        values.append(["bcdDevice", String(bcdDevice, radix: 16)].joined(separator: ": "))
        values.append(["iManufacturer", String(iManufacturer, radix: 16)].joined(separator: ": "))
        values.append(["iProduct", String(iProduct, radix: 16)].joined(separator: ": "))
        values.append(["iSerialNumber", String(iSerialNumber, radix: 16)].joined(separator: ": "))
        values.append(["bNumConfigurations", String(bNumConfigurations, radix: 16)].joined(separator: ": "))
...
extension libusb_interface_descriptor: CustomStringConvertible {
    public var description: String {
        ...
        values.append(["bLength", String(bLength, radix: 16)].joined(separator: ": "))
        values.append(["bDescriptorType", String(bDescriptorType, radix: 16)].joined(separator: ": "))
        values.append(["bInterfaceNumber", String(bInterfaceNumber, radix: 16)].joined(separator: ": "))
        values.append(["bAlternateSetting", String(bAlternateSetting, radix: 16)].joined(separator: ": "))
        values.append(["bNumEndpoints", String(bNumEndpoints, radix: 16)].joined(separator: ": "))
        values.append(["bInterfaceClass", String(bInterfaceClass, radix: 16)].joined(separator: ": "))
        values.append(["bInterfaceSubClass", String(bInterfaceSubClass, radix: 16)].joined(separator: ": "))
        values.append(["bInterfaceProtocol", String(bInterfaceProtocol, radix: 16)].joined(separator: ": "))
        values.append(["iInterface", String(iInterface, radix: 16)].joined(separator: ": "))
        if let bytes = bytes {
            values.append("bytes: " + "[" + bytes.map(\.description).joined(separator: ", ") + "]")
        }
        return "(" + values.joined(separator: ", ") + ")"
